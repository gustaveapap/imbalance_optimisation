...
# =============================================================================
# MODE CONTINU  (python sim_fr_2026.py --continuous)
# =============================================================================

def run_continuous():
    """Simule chaque nouveau jour des que les donnees sont disponibles (vers 02:00)."""
    print(SEP)
    print("  SIMULATION SOLAIRE FR 2026 -- MODE CONTINU")
    print(SEP)

    print("\n  PVGIS..."); df_pvgis = dl_pvgis()
    print("  Auth RTE..."); ensure_token(); print("  OK")
    ...
    while True:
        ...
        if not new_dates:
            ...
            print(f"  [{datetime.now().strftime('%H:%M')}] FR Solar a jour ({last_sim}). "
