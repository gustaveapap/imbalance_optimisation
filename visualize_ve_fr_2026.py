...
Visualisation VE FR 2026 — 2 panneaux
  ...
  Bas   : nuage de points des événements de charge S1 (meilleure stratégie FR)
...
STRAT_STYLES = {
    "S1":        {"color": "#00d4ff", "lw": 2.5, "zorder": 5},
    "S_BE_OPT":  {"color": "#a8e6cf", "lw": 1.5, "zorder": 3},
...
# S1 est la meilleure stratégie FR (ISP FR moins négatifs)
best = "S1"
...
ax1.set_title(
    f"VE FR 2026 - Strategies de charge intelligente\n"
    f"S1 (meilleure FR) total : {best_total:+.2f} EUR  "
    f"({date_min} -> {date_max})",
...
ax2.set_title("Evenements de charge S1 - ISP au declenchement",
