...
CSV_IN  = Path("outputs/ve_fr/simulation_ve_fr_2026.csv")
PNG_OUT = Path("outputs/reports/ve_fr_2026.png")
...
fig.suptitle(
    f"VE France 2026 — Coût recharge  |  S_BE_opt total : {sign}{total_opt:.2f} €",
